		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#responsivetable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"responsivetable-display": {
								"semanticObject": "responsivetable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=responsivetable",
									"url": sap.ui.require.toUrl("responsivetable")
								}
							}
						}
					}
